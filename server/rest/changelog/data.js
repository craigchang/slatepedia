...
module.exports = [
  {
    ...
    "message": "Shields browse now supports filters: durability and parry power (min/max sliders), and availabilities (multi-select). The list updates from the API when filters change, consistent with other filtered categories."
  },
  {
    "version": "0.7.5",
